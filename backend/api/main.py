...
try:
    ...
    from backend.project_paths import ENV_FILE
...
def _load_api_version() -> str:
    ...
    try:
        return distribution_version("alphascope")
...
if HAS_FASTAPI:
    ...
    def _custom_openapi() -> dict[str, Any]:
        ...
        security_schemes["LocalApiToken"] = {
            "type": "apiKey",
            "in": "header",
            "name": LOCAL_TOKEN_HEADER,
            ...
            for path, path_item in schema.get("paths", {}).items():
                ...
                for method, operation in path_item.items():
                    if method in _OPENAPI_METHODS and isinstance(operation, dict):
                        operation["security"] = [{"LocalApiToken": []}]
    ...
    def _meaningful_price_bars(symbol: str, limit: int = 30, end_date: str | None = None) -> list[dict[str, Any]]:
        bars = get_prices(symbol, limit=limit, end_date=end_date)
        return [
            bar
            for bar in bars
        ...
        return ApiResponse(
            ...
            data=AnalysisResultData(
                ...
                result={
                    ...
                    "research_trust": result.get("research_trust"),
